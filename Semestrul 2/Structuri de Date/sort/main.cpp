...
void sort_using(string sort_method, vector<LL> b){
    ...
    if(sort_method=="quick") quicksort(b, 0, b.size()-1);
    else if(sort_method=="merge") mergesort(b, 0, b.size()-1);
    else if(sort_method=="radix") radixsort(b);
    else if(sort_method=="count"){
        if(b.size()<10000)
            countsort(b);
        else{
            cout << "\nError: list to big, could not sort using countsort";
            return;
        }
    }
        ...
        if(b.size()<10000)
            ...
            cout << "\nError: list to big, could not sort using bubblesort";
            return;
        }
    }
    else{
